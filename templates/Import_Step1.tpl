...
<table width="100%" cellspacing="0" cellpadding="2">
	<tr>
		<td><strong>{'CSV_LBL_IMPORT_STEP_1'|@vtranslate:$MODULE}:</strong></td>
		<td class="big">{'CSV_LBL_IMPORT_STEP_1_DESCRIPTION'|@vtranslate:$MODULE}</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td>{'CSV_LBL_IMPORT_SUPPORTED_FILE_TYPES'|@vtranslate:$MODULE}</td>
	</tr>
</table>