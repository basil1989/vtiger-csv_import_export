...
class CsvImport_Lists_View extends Vtiger_Popup_View{
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		$listViewModel = CsvImport_ListView_Model::getInstance($moduleName, $cvId);
    ...
    public function getImportDetails(Vtiger_Request $request) {
        ...
        $importRecords= CsvImport_Data_Action::getImportDetails($user);
