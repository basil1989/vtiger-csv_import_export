	...
	<form action="index.php" enctype="multipart/form-data" method="POST" name="importAdvanced">
		...
		<table style=" width:90%;margin-left: 5%" cellpadding="2" cellspacing="12" class="searchUIBasic">
			...
			<tr>
				...
				{include file='Import_Step2.tpl'|@vtemplate_path:'CsvImport'}
				</td>
				<td class="leftFormBorder1" width="40%" valign="top">
				{include file='Import_Step3.tpl'|@vtemplate_path:'CsvImport'}
				</td>
			</tr>
			<tr>
				<td align="right" colspan="2">
				{include file='Import_Advanced_Buttons.tpl'|@vtemplate_path:'CsvImport'}
				</td>
			</tr>
		</table>
	</form>
